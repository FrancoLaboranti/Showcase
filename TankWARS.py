...
# mecanica shift para acelerar, reemplazando la de la barra para el escudo (que el escudo se active igual que la maquina)
# que se pueda stackear misiles (y mejorarlo en shop)
# hacerlo mas divertido en el movimiento y jugabilidad
# la maquina sepa esquivar en un sentido u otro las cajas no solo por la derecha